...
public class DBAdapter6 
{
	...
	private static final String DATABASE_TABLE = "Map_Information";
	...
	public static final String DATABASE_CREATE="Create Table Map_Information(Name varchar2(50), Longitude varchar2(100),Latitude varchar2(20))";
...
*/
	...
	public  void insertContact(String event,String longitude,String latitude)
	{
		
	ContentValues initialValues = new ContentValues();
	initialValues.put(KEY_NAME, event);
	...
	*/
	...
	System.out.println(user_category);
		...
		String q="Select * from Map_Information where Name = ?";
